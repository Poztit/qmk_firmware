...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEFAULT] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX, LOWER,   KC_DEL,  KC_SPC,   KC_ENT, KC_BSPC, RAISE,   KC_ALGR, KC_EQL,  KC_LBRC, KC_RBRC
    ),

    [_RAISE] = LAYOUT(
        KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
        KC_TAB,  _______, KC_UP,   _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
        XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,                   _______, KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT, _______,
        KC_LSFT, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
        KC_LCTL, KC_LGUI, KC_LALT, _______, LOWER,   KC_DEL,  KC_SPC,   KC_ENT, KC_BSPC, RAISE,   KC_ALGR, _______, _______, _______
    ),
